    ...
    private void update(Player player) {
        ...
        if (objective == null) {
            ...
            objective = board.registerNewObjective(OBJECTIVE_NAME, Criteria.DUMMY,
                    ComponentBuilder.parse("<gold><bold>Cosmic"));
        ...
        experienceScore.customName(ComponentBuilder.parse("<yellow>Experience: <white>"
        ...
        energyScore.customName(ComponentBuilder.parse("<aqua>Energy: <white>"
